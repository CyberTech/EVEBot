...
objectdef obj_Configuration
{
	...
	variable obj_Configuration_JetcanMiner JetcanMiner
...
objectdef obj_Configuration_JetcanMiner
{
	variable string SetName = "JetcanMiner"
	...
	member:settingsetref JetcanMinerRef()
	{
		return ${BaseConfig.BaseRef.FindSet[${This.SetName}]}
	}
	...
	method Set_Default_Values()
	{
		...
		This.JetcanMinerRef:AddSetting[UseMultipleCans,TRUE]
		This.JetcanMinerRef:AddSetting[Solo,TRUE]
		This.JetcanMinerRef:AddSetting[JetcanLife,50]
		This.JetcanMinerRef:AddSetting[JetcanVolume,10000]
		This.JetcanMinerRef:AddSetting[MiningShipName,"Osprey"]
		This.JetcanMinerRef:AddSetting[HaulingShipName,"Mark"]
	}
	
	member:bool UseMultipleCans()
	{
		return ${This.JetcanMinerRef.FindSetting[UseMultipleCans,TRUE]}
	}
	method SetUseMultipleCans(bool value)
	{
		This.JetcanMinerRef:AddSetting[UseMultipleCans,${value}]
	} 

	member:bool Solo()
	{
		return ${This.JetcanMinerRef.FindSetting[Solo,TRUE]}
	}
	method SetSolo(bool value)
	{
		This.JetcanMinerRef:AddSetting[Solo,${value}]
	} 
	
	member:int JetcanLife()
	{
		return ${This.JetcanMinerRef.FindSetting[JetcanLife,50]}
	}
	method SetJetcanLife(int value)
	{
		This.JetcanMinerRef:AddSetting[JetcanLife,${value}]
	}
	
	member:int JetcanVolume()
	{
		return ${This.JetcanMinerRef.FindSetting[JetcanVolume,10000]}
	}
	method SetJetcanVolume(int value)
	{
		This.JetcanMinerRef:AddSetting[JetcanVolume,${value}]
	}
	
	member:string MiningShipName()
	{
		return ${This.JetcanMinerRef.FindSetting[MiningShipName,"Osprey"]}
	}
	method SetMiningShipName(string value)
	{
		This.JetcanMinerRef:AddSetting[MiningShipName,${value}]
	}
	
	member:string HaulingShipName()
	{
		return ${This.JetcanMinerRef.FindSetting[HaulingShipName,"Badger"]}
	}
	method SetHaulingShipName(string value)
	{
		This.JetcanMinerRef:AddSetting[HaulingShipName,${value}]
	}
}
