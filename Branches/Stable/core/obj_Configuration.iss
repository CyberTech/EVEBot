...
objectdef obj_Configuration_Miner
{
	...
	method Set_Default_Values()
	{
		...
		; New Null Sec Ore (12/31/2024)
		This.OreTypesRef:AddSetting[Bootleg Ytirium, 1]
		This.OreTypesRef:AddSetting[Firewater Ytirium, 1]
		This.OreTypesRef:AddSetting[Moonshine Ytirium, 1]
		This.OreTypesRef:AddSetting[Ytirium, 1]
		This.OreTypesRef:AddSetting[Foggy Ueganite, 1]
		This.OreTypesRef:AddSetting[Overcast Ueganite, 1]
		This.OreTypesRef:AddSetting[Stormy Ueganite, 1]
		This.OreTypesRef:AddSetting[Ueganite, 1]
		This.OreTypesRef:AddSetting[Abyssal Talassonite, 1]
		This.OreTypesRef:AddSetting[Hadal Talassonite, 1]
		This.OreTypesRef:AddSetting[Talassonite, 1]
		This.OreTypesRef:AddSetting[Abyssal Rakovene, 1]
		This.OreTypesRef:AddSetting[Hadal Rakovene, 1]
		This.OreTypesRef:AddSetting[Nesosilicate Rakovene, 1]
		This.OreTypesRef:AddSetting[Rakovene, 1]
		This.OreTypesRef:AddSetting[Plum Mordunium, 1]
		This.OreTypesRef:AddSetting[Plunder Mordunium, 1]
		This.OreTypesRef:AddSetting[Prize Mordunium, 1]
		This.OreTypesRef:AddSetting[Mordunium, 1]
		This.OreTypesRef:AddSetting[Adobe Kylixium , 1]
		This.OreTypesRef:AddSetting[Argil Kylixium , 1]
		This.OreTypesRef:AddSetting[Kaolin Kylixium , 1]
		This.OreTypesRef:AddSetting[Kylixium , 1]
		This.OreTypesRef:AddSetting[Dull Hezorime, 1]
		This.OreTypesRef:AddSetting[Serrated Hezorime, 1]
		This.OreTypesRef:AddSetting[Sharp Hezorime, 1]
		This.OreTypesRef:AddSetting[Hezorime, 1]
		This.OreTypesRef:AddSetting[Clear Griemeer, 1]
		This.OreTypesRef:AddSetting[Inky Griemeer, 1]
		This.OreTypesRef:AddSetting[Opaque Griemeer, 1]
		This.OreTypesRef:AddSetting[Griemeer, 1]
		This.OreTypesRef:AddSetting[Augmented Eifyrium, 1]
		This.OreTypesRef:AddSetting[Boosted Eifyrium, 1]
		This.OreTypesRef:AddSetting[Doped Eifyrium, 1]
		This.OreTypesRef:AddSetting[Eifyrium, 1]
		This.OreTypesRef:AddSetting[Imperial Ducinium, 1]
		This.OreTypesRef:AddSetting[Noble Ducinium, 1]
		This.OreTypesRef:AddSetting[Royal Ducinium, 1]
		This.OreTypesRef:AddSetting[Ducinium, 1]
		This.OreTypesRef:AddSetting[Abyssal Bezdnacine, 1]
		This.OreTypesRef:AddSetting[Hadal Bezdnacine, 1]
		This.OreTypesRef:AddSetting[Bezdnacine, 1]
